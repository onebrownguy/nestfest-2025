...
export const AISchemas = {
  enhance: z.object({
    ...
    context: z.enum(['project_description', 'competition_pitch', 'executive_summary', 'general'] as const).default('project_description'),
    target_length: z.enum(['maintain', 'expand', 'condense'] as const).default('maintain'),
    tone: z.enum(['professional', 'enthusiastic', 'technical', 'conversational'] as const).default('professional'),
    focus_areas: z.array(z.enum(['clarity', 'impact', 'technical_detail', 'market_appeal', 'innovation'] as const)).default(['clarity', 'impact'])
  })
}