...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-75",
  {
    variants: {
      variant: {
        default: "bg-blue-600 text-white hover:bg-blue-700 disabled:bg-gray-400 disabled:text-gray-700",
        destructive:
          "bg-red-600 text-white hover:bg-red-700 disabled:bg-gray-400 disabled:text-gray-700",
        outline:
          "border border-gray-300 bg-white text-gray-900 hover:bg-gray-50 hover:text-gray-900 disabled:bg-gray-100 disabled:text-gray-500 disabled:border-gray-200",
        secondary:
          "bg-gray-200 text-gray-900 hover:bg-gray-300 disabled:bg-gray-100 disabled:text-gray-500",
